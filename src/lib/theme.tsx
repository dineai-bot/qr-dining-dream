...
export type ThemeId =
  ...
  | "ruby" | "jade" | "azure" | "amethyst";

export const lightThemes: ThemeId[] = ["emerald"];
export const pastelThemes: ThemeId[] = [];
...
export const themes: { id: ThemeId; name: string; note: string; swatch: string[] }[] = [
  ...
  { id: "ruby", name: "Ruby Lacquer", note: "Lacquered red · bright gold", swatch: ["#1b0509", "#7d0b22", "#ffcf5c"] },
  { id: "jade", name: "Imperial Jade", note: "Jade green · liquid gold", swatch: ["#04140f", "#0c6b4f", "#5ff2b6"] },
  { id: "azure", name: "Electric Azure", note: "Cobalt · neon cyan", swatch: ["#040c1f", "#0b3fb0", "#4fd8ff"] },
  { id: "amethyst", name: "Amethyst Neon", note: "Violet · magenta shine", swatch: ["#100425", "#5a1fb8", "#ff6ad5"] },
